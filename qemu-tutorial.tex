...
\begin{block}{}
\textit{To unbind \textbf{\textcolor{blue}{01:00.0}} from NVMe driver and register to vfio-pci driver (VF creation skipped):} \newline
...
\end{block}
\begin{block}{}
\textit{To unbind VF device from igbvf driver and register to vfio-pci driver:}
