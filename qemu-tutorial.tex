...
\section{VFIO \& NVMe}
\begin{frame}
\frametitle{VFIO \& NVMe}
\begin{block}{}
we will pass below.... \newline
01:00.0 Non-Volatile memory controller: Intel Corporation Device f1a6 (rev 03) \newline

host\# echo 0000:01:00.0 $>$ /sys/bus/pci/devices/0000$\backslash$:01$\backslash$:00.0/driver/unbind \newline
host\# lspci -ns 0000:01:00.0 \newline
01:00.0 0108: 8086:f1a6 (rev 03) \newline
host\# echo "8086 f1a6" $>$ /sys/bus/pci/drivers/vfio-pci/new\_id
\end{block}
\begin{block}{}
